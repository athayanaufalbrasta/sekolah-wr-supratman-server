...
const endpointsFiles = [
	...
	path.join(projectRoot, "src/routes/beritaRoute"),
	path.join(projectRoot, "src/routes/kegiatanRoute"),
	path.join(projectRoot, "src/routes/pengumumanRoute"),
	path.join(projectRoot, "src/routes/authRoute"),
	path.join(projectRoot, "src/routes/userRoute"),
	path.join(projectRoot, "src/routes/siswaRoute"),
	path.join(projectRoot, "src/routes/kontenWebRoute"),
	// path.join(projectRoot, "src/routes/fileUploadRoute"),
];
